    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#00B67A] text-white p-12 flex-col justify-between">
        ...
        <div className="max-w-md">
          ...
          <p className="text-xl opacity-90">
            Continue tracking your expenses and achieving your financial goals.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-4xl font-bold mb-2 text-gray-900">Sign In</h2>
            <p className="text-gray-600">
              Don't have an account?{' '}
              <a href="/signup" className="text-[#00B67A] hover:underline font-semibold">
                Sign up
              </a>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-gray-300 text-[#00B67A] focus:ring-[#00B67A]"
                />
                <span className="text-sm text-gray-600">Remember me</span>
              </label>
              <a href="#" className="text-sm text-[#00B67A] hover:underline">
                Forgot password?
              </a>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#00B67A] text-white py-3 rounded-md font-semibold hover:bg-[#009966] transition-colors disabled:opacity-50"
            >
          ...
          <div className="space-y-3">
            <button 
              ...
              className="w-full border-2 border-gray-200 py-3 rounded-md font-semibold hover:border-[#00B67A] hover:text-[#00B67A] transition-colors flex items-center justify-center gap-2"
            >
